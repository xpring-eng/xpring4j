...
import org.interledger.spsp.server.model.ImmutableStreamConnectionDetails.Builder;
 ...
 * @deprecated This is a dup of StreamConnectionDetails as defined in Quilt, but is necessary because `SharedSecret`
 *   doesn't deserialize properly to JSON in the Quilt version.
 */
@Immutable
